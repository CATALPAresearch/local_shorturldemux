 ...
 * 
 * TODO: replace 4_GET by soething like: $shorturl_param = optional_param('shorturl', null, PARAM_ALPHANUMEXT);
 * if (!$shorturl_param) {
...
// Store the requested URL in a session to redirect after login
